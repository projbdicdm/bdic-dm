...
class Monitor {
     ...
     * @var string
     */
    private $dataTemplateCSS = 'position: fixed; top: 10px; left:800px; box-shadow:0 0 8px #555; background: #FFF; padding: 5px; color:#000 !important; z-index: 9999';
    ...
    private function generateHTML($data)
    {
        ...
        if (isset($_REQUEST["tempo"])) $tempo = $_REQUEST["tempo"];

        $table = '<table><thead><tr style="background:#EEE;">
                  <td style="padding:5px;">Tempo Exe.</td>
                  <td style="padding:5px;">Tempo Sol.</td>
                  <td style="padding:5px;">Registros</td>
                  <td style="padding:5px;">Memória</td>
                  <td style="padding:5px;">%</td>
                  </tr></thead><tbody>';

        $table_row = '<tr>

                      <td style="padding:5px">%s</td style="padding:5px">
                      <td style="padding:5px">%s</td style="padding:5px">
